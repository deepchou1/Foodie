...
$input-color-placeholder:        lighten($white,40%) !default;
...
$navbar-inverse-color:                 rgba($white,1) !default;
$navbar-inverse-hover-color:           rgba($orange,.75) !default;
$navbar-inverse-active-color:          rgba($orange,1) !default;
